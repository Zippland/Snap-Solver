...
- bug问题：请提交 Issue
- 获取高级版本（简单的启动、更强的AI、国内访问），请发送邮件至 [zylanjian@outlook.com](mailto:zylanjian@outlook.com) 或联系小红书

| 功能                | 该版本                                    | 高级版                                      |
|--------------------|------------------------------------------|--------------------------------------------|
| **AI 模型**       | 基础 gpt-4o 模型                                    | 与 Claude-3.5-sonnet(new) 混用，各取所长，提供更准确的解答       |
| **启动便捷性**        | 手动启动，需要用户自行配置环境依赖                    | 一键启动，无需手动配置依赖  |
| **VPN代理支持**       | 不支持代理功能                                | 支持vpn配置，更适应多样网络环境           |
| **快捷键设置**    | 仅支持 `alt+ctrl+s` 快捷键                            | 可自定义配置快捷键功能         |
| **技术支持**    | 基本文档和 FAQ 支持                                | 一对一代部署支持，提供高级定制解决方案           |
