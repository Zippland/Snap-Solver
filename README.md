...
Snap-Solver 是一个针对网络笔试、测评的智能题目解答工具，只需按下快捷键，即可在另一台设备上自动识别题目内容并给出详细解答。

## 📞 获取帮助

- bug问题：请提交 Issue
- 人工服务（如需要代为部署、需要更多AI支持、需要国内访问等），请发送邮件至 [zylanjian@outlook.com](mailto:zylanjian@outlook.com)
