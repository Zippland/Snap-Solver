...
- bug问题：请提交 Issue
- 获取高级版本（简单的启动、更强的AI、国内访问），请发送邮件至 [zylanjian@outlook.com](mailto:zylanjian@outlook.com)

| 功能                | 该版本                                    | 高级版                                      |
|--------------------|------------------------------------------|--------------------------------------------|
| **AI 解答引擎**       | 基础 gpt 模型                                    | Claude-3.5-sonnet(new) 兼容支持，提供更准确的解答       |
| **启动便捷性**        | 手动启动，需要用户自行配置环境依赖                    | 便捷的一键启动，无需手动配置依赖  |
| **VPN代理支持**       | 不支持代理功能，部分vpn可用                                | 支持vpn配置，更适应多样网络环境           |
